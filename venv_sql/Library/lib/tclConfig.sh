...
# installed.
TCL_PREFIX='C:/VILLGAX/CODES/Projects/Meme Generator/venv_sql\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/VILLGAX/CODES/Projects/Meme Generator/venv_sql\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/VILLGAX/CODES/Projects/Meme Generator/venv_sql\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/VILLGAX/CODES/Projects/Meme Generator/venv_sql\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/VILLGAX/CODES/Projects/Meme Generator/venv_sql\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/VILLGAX/CODES/Projects/Meme Generator/venv_sql\Library\lib\tclstub86.lib'
